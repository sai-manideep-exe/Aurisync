      ...
      <div className="border border-primary/50 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-base-100 rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 p-4 sm:p-8 flex flex-col">
          ...
          <div className="mb-4 flex items-center justify-start gap-2">
            <img src="/Logo.png" alt="Logo" className="w-20 h-25" />
            <span className="text-3xl font-bold font-roboto pb-2 bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary  tracking-wider">
              Aurisync
            </span>
          </div>
          ...
          <div className='w-full'>
            <form onSubmit={handleLogin}>
              <div className="space-y-4">
                ...
                <button type="submit" className="btn bg-primary/50 rounded-full hover:btn-secondary duration-200 ease-in-out w-full" disabled={isPending}>
                    {isPending ? (
                      <>
